...
define('TEXT_AFFILIATE_INDIVIDUAL_BANNER_VIEW', 'to see id of available products.');
define('TEXT_AFFILIATE_INDIVIDUAL_BANNER_HELP', 'Select id in popup window and type this id in Model No. field.');

define('TEXT_VALID_PRODUCTS_LIST', 'Available products');
define('TEXT_VALID_PRODUCTS_ID', 'Model No.');
define('TEXT_VALID_PRODUCTS_NAME', 'Name');
