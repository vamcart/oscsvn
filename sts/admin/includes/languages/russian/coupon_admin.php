...
define('HEADING_TITLE_STATUS', 'Сортировка: ');
...
define('COUPON_BUTTON_PREVIEW', 'Предварительный просмотр');
define('COUPON_BUTTON_CONFIRM', 'Подтвердить');
define('COUPON_BUTTON_BACK', 'Вернуться');

define('ERROR_NO_COUPON_AMOUNT', 'Ошибка: Не указан номинал купона');
define('ERROR_NO_COUPON_NAME', 'Ошибка: Не указано название купона');
define('ERROR_COUPON_EXISTS', 'Ошибка: Купон уже существует');

define('COUPON_VIEW', 'Смотреть');
