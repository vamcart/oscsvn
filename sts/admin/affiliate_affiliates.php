<?php
/*
  $Id: affiliate_affiliates.php,v 1.2 2003/09/24 13:57:05 wilt Exp $
...
<?php
    ...
    $affiliate_split = new splitPageResults($_GET['page'], MAX_PROD_ADMIN_SIDE, 
    ...
    while ($affiliate = tep_db_fetch_array($affiliate_query)) {
      ...
      if (((!$_GET['acID']) || (@$_GET['acID'] == $affiliate['affiliate_id'])) && (!$aInfo)) {
        ...
        $aInfo_array = array_merge((array)$affiliate, $affiliate_info);
...
?>
              <tr>
                <td colspan="6"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="smallText" valign="top"><?php echo $affiliate_split->display_count($affiliate_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_AFFILIATES); ?></td>
                    <td class="smallText" align="right"><?php echo $affiliate_split->display_links($affiliate_query_numrows, MAX_PROD_ADMIN_SIDE, MAX_DISPLAY_PAGE_LINKS, $_GET['page'], tep_get_all_get_params(array('page', 'info', 'x', 'y', 'acID'))); ?></td>
                  </tr>
<?php
