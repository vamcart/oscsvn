...
define('TEXT_MORE_INFORMATION', 'For more information, please visit this articles <a href="%s" target="_blank"><u>' .  $article['articles_name'].'</u></a>.');
...
define('TEXT_ARTICLES_SEARCH', 'Search in articles: ');
