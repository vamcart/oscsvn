...
define('HEADING_AFFILIATE_PROGRAM_TITLE', 'Партнёрская программа ' . STORE_NAME . '');
define('TEXT_INFORMATION', 'Представляем Вашему вниманию партнёрскую программу ' . STORE_NAME . '.<br>
Мы платим партнёрам за привлечение новых покупателей в наш магазин, Ваша комиссия может составлять от <b>1%</b> до <b>5%</b> процентов от стоимости заказа, оформленного через Вас.<br><br>
...
Начальная комиссия устанавливается в размере <b>1%</b> и может быть увеличина до 5% по усмотрению администрации, это зависит от количества и суммы заказов, оформленных через Вас за время работы в нашей партнёрской программе.<br>
<br>
<b>Правила партнёрской программы ' . STORE_NAME . ':</b>
<br>
<br>
...
<br>
Мы будем выплачивать Вам комиссию, установленную в размере <b>1%</b> от стоимости <b>оплаченного</b> заказа.
<br>
<br>
