...
<!-- body_text //-->
    <td width="100%" valign="top">
      ...
      <tr>
        <td>
		  <table border="0" width="100%" cellspacing="0" cellpadding="0"><?php echo tep_draw_form('wishlist_form', $_PHP_SELF); ?>
          <tr>
...
?>
	  ...
	  <tr>
		<td align="right"><br /><?php echo tep_image_submit('button_in_cart.gif', IMAGE_BUTTON_IN_CART, 'name="add_prod" value="add_prod"'); ?></td>
 	  </tr>
	  <tr>
		<td>
