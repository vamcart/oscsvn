...
// unregister session variables used during checkout
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Ŵàçŵåøèòü ìîäóëü îïëàòû LiqPAY', 'MODULE_PAYMENT_LIQPAY_STATUS', 'True', 'Ŵàçŵåøèòü ìîäóëü îïëàòû LiqPAY?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ìåŵṫàíò ID', 'MODULE_PAYMENT_LIQPAY_ID', '', 'Óêàæèòå Âàø èäåíòèôèêàöèîííûûé íîìåŵ (ìåŵṫàíò id).', '6', '2', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ïîŵÿäîê ñîŵòèŵîâêè.', 'MODULE_PAYMENT_LIQPAY_SORT_ORDER', '0', 'Ïîŵÿäîê ñîŵòèŵîâêè ìîäóëÿ.', '6', '3', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Çîíà îïëàòû', 'MODULE_PAYMENT_LIQPAY_ZONE', '0', 'Åñëè âûáŵàíà çîíà, äàííûé ìîäóëü îïëàòû áóäåò äîñòóïåí òîëüêî ïîêóïàòåëÿì èç óêàçàííîé çîíû.', '6', '4', 'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ìåŵṫàíò ïàŵîëü (ïîäïèñü)', 'MODULE_PAYMENT_LIQPAY_SECRET_KEY', '0', 'Â äàííîé îïöèè óêàæèòå ïàŵîëü (ïîäïèñü), óêàçàííûé â íàñòŵîéêàõ íà ñàéòå LiqPAY.', '6', '5', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Óêàæèòå îïëàṫåííûé ñòàòóñ çàêàçà', 'MODULE_PAYMENT_LIQPAY_ORDER_STATUS_ID', '0', 'Óêàæèòå îïëàṫåííûé ñòàòóñ çàêàçà', '6', '6', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    }
