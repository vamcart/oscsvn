...
*/
  ...
  define('MODULE_PAYMENT_PAYONLINESYSTEM_TEXT_ADMIN_DESCRIPTION', 'Модуль оплаты PayOnline System (Visa, Mastercard)<br />Как правильно настроить модуль читайте <a href="http://oscommerce.su/modules/smartsection/item.php?itemid=16" target="_blank"><u>здесь</u></a>.');
