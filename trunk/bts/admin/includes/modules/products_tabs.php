...
?>
                      <tr>
                        ...
                        <td class="main"><?php echo tep_draw_textarea_field ('products_tab_1[' . $languages[$i]['id'] . ']', 'soft', '120', '15', (isset($products_tab_1[$languages[$i]['id']]) ? $products_tab_1[$languages[$i]['id']] : $products_tabs[$languages[$i]['id']]['1']) ); ?></td>
                      </tr>
                      <tr>
...
?>
                      <tr>
                        <td valign="top"><?php echo tep_image (DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?>&nbsp;</td>
                        <td valign="top" class="main" width="0"><?php echo tep_draw_textarea_field ('products_tab_2[' . $languages[$i]['id'] . ']', 'soft', '120', '15', (isset($products_tab_2[$languages[$i]['id']]) ? $products_tab_2[$languages[$i]['id']] : $products_tabs[$languages[$i]['id']]['2']) ); ?></td>
                      </tr>
                      <tr>
                        <td><?php echo tep_draw_separator ('pixel_trans.gif', '100%', '10'); ?></td>
                      </tr>
...
?>
                      <tr>
                        <td valign="top"><?php echo tep_image (DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?></td>
                        <td valign="top" class="main" width="0"><?php echo tep_draw_textarea_field ('products_tab_3[' . $languages[$i]['id'] . ']', 'soft', '120', '15', (isset($products_tab_3[$languages[$i]['id']]) ? $products_tab_3[$languages[$i]['id']] : $products_tabs[$languages[$i]['id']]['3']) ); ?></td>
                      </tr>
                      <tr>
                        <td><?php echo tep_draw_separator ('pixel_trans.gif', '100%', '10'); ?></td>
                      </tr>
...
?>
                      <tr>
                        <td valign="top"><?php echo tep_image (DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?></td>
                        <td valign="top" class="main" width="0"><?php echo tep_draw_textarea_field ('products_tab_4[' . $languages[$i]['id'] . ']', 'soft', '120', '15', (isset($products_tab_4[$languages[$i]['id']]) ? $products_tab_4[$languages[$i]['id']] : $products_tabs[$languages[$i]['id']]['4']) ); ?></td>
                      </tr>
                      <tr>
                        <td><?php echo tep_draw_separator ('pixel_trans.gif', '100%', '10'); ?></td>
                      </tr>
...
?>
                      <tr>
                        <td valign="top"><?php echo tep_image (DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?></td>
                        <td class="main" width="0"><?php echo tep_draw_textarea_field ('products_tab_5[' . $languages[$i]['id'] . ']', 'soft', '120', '15', (isset ($products_tab_5[$languages[$i]['id']]) ? $products_tab_5[$languages[$i]['id']] : $products_tabs[$languages[$i]['id']]['5']) ); ?></td>
                      </tr>
                      <tr>
                        <td><?php echo tep_draw_separator ('pixel_trans.gif', '100%', '10'); ?></td>
                      </tr>
...
?>
                      <tr>
                        <td valign="top"><?php echo tep_image (DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']); ?></td>
                        <td class="main"><?php echo tep_draw_textarea_field ('products_tab_6[' . $languages[$i]['id'] . ']', 'soft', '120', '15', (isset($products_tab_6[$languages[$i]['id']]) ? $products_tab_6[$languages[$i]['id']] : $products_tabs[$languages[$i]['id']]['6']) ); ?></td>
                      </tr>
                      <tr>
                        <td><?php echo tep_draw_separator ('pixel_trans.gif', '100%', '10'); ?></td>
                      </tr>
