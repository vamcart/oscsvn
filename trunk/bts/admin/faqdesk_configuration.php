...
"select configuration_group_key, configuration_group_title from " . TABLE_FAQDESK_CONFIGURATION_GROUP . " where configuration_group_id = '" . $_GET['gID'] . "'"
);
...
<?php
 ...
 "select configuration_id, configuration_title, configuration_key, configuration_value, use_function from " . TABLE_FAQDESK_CONFIGURATION . " where configuration_group_id = '" . $_GET['gID'] . "' order by sort_order"
);
