<?php
/*
  $Id: affiliate_faq.php,v 1.1.1.1 2003/09/18 19:04:31 wilt Exp $
...
define('NAVBAR_TITLE', 'Партнёрская программа - FAQ');
define('HEADING_TITLE', 'Партнёрская программа - FAQ');

define('TEXT_INFORMATION', 'Список частозадаваемых вопросов по партнёрской программе ' . STORE_NAME . '.<br>
 Если Вы не нашли ответа на свой вопрос, задайте нам его <a href="' . tep_href_link(FILENAME_AFFILIATE_CONTACT). '">здесь</a>, мы ответим в кротчайшие сроки.<br>
<ul>
<li><a href="' . tep_href_link('affiliate_faq.php') . '#1">Как мне получить заработанные у вас деньги?</a>
<li><a href="' . tep_href_link('affiliate_faq.php') . '#2">Как и в каком месте лучше всего рамещать партнёрские ссылки?</a>
<li><a href="' . tep_href_link('affiliate_faq.php') . '#3">Могу ли я изменять HTML-код, который мне нужно ставить на сайт?</a>
<li><a href="' . tep_href_link('affiliate_faq.php') . '#4">Что будет если покупатель, который пришёл с моего сайте не оплатит заказ?</a>
</ul>
<hr width ="90%">
<BR>
<FONT COLOR="#000000" size="4"><B><U>FAQ</U></B></FONT>
<p style="line-height: 100%; word-spacing: 0; text-indent: 0; margin: 0"><font color="maroon">Как мне получить заработанные у вас деньги?</font><a name="1"></a><br>
Чтобы получить выплату партнёрской комиссии, на Вашем аккаунте должно быть как минимум <b>10$</b>. В случае, если заработанная Вами партнёрская комиссия не превышает <b>10$</b>, деньги остаются на Вашем аккаунте до тех пор, пока сумма комиссии не достигнет по крайней мере <b>10$</b>. Оплата партнёрских комиссий производится каждые <b>2 недели</b>. Выплаты производятся на Ваш кошелёк в системе WebMoney.</p>
<p align="right" style="line-height: 100%; word-spacing: 0; text-indent: 0; margin: 0"><a href="' . tep_href_link('affiliate_faq.php') . '#0">наверх</a></p>
