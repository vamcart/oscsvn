...
// unregister session variables used during checkout
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Ŵàçŵåøèòü ìîäóëü îïëàòû WebMoney', 'MODULE_PAYMENT_WEBMONEY_MERCHANT_STATUS', 'True', 'Ŵàçŵåøèòü ìîäóëü îïëàòû WebMoney?', '6', '3', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Âàø WM ID', 'MODULE_PAYMENT_WEBMONEY_MERCHANT_ID', '', 'Óêàæèòå Âàø WM èäåíòèôèêàòîŵ.', '6', '4', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Âàø WMR êîøåëẁê', 'MODULE_PAYMENT_WEBMONEY_MERCHANT_WMR', '', 'Óêàæèòå Âàø WMR êîøåëẁê.', '6', '5', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ïîŵÿäîê ñîŵòèŵîâêè.', 'MODULE_PAYMENT_WEBMONEY_MERCHANT_SORT_ORDER', '0', 'Ïîŵÿäîê ñîŵòèŵîâêè ìîäóëÿ.', '6', '6', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Çîíà îïëàòû', 'MODULE_PAYMENT_WEBMONEY_MERCHANT_ZONE', '0', 'Åñëè âûáŵàíà çîíà, äàííûé ìîäóëü îïëàòû áóäåò äîñòóïåí òîëüêî ïîêóïàòåëÿì èç óêàçàííîé çîíû.', '6', '7', 'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Ñåêŵåòíûé êëŷṫ', 'MODULE_PAYMENT_WEBMONEY_MERCHANT_SECRET_KEY', '0', 'Â äàííîé îïöèè óêàæèòå Âàø êëŷṫ, óêàçàííûé â îïöèè Secret Key íà ñàéòå WebMoney Merchant.', '6', '8', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Óêàæèòå îïëàṫåííûé ñòàòóñ çàêàçà', 'MODULE_PAYMENT_WEBMONEY_MERCHANT_ORDER_STATUS_ID', '0', 'Óêàæèòå îïëàṫåííûé ñòàòóñ çàêàçà', '6', '9', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    }
