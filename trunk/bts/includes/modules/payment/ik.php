...
// class methods
    ...
    function selection() {
      global $cart_interkassa_id;

      if (tep_session_is_registered('cart_interkassa_id')) {
        $order_id = substr($cart_interkassa_id, strpos($cart_interkassa_id, '-')+1);
        ...
        if (tep_db_num_rows($check_query) < 1) {
          ...
          tep_session_unregister('cart_interkassa_id');
        }
      }
    ...
    function confirmation() {
      ...
      if (tep_session_is_registered('cartID')) {
        ...
        if ($insert_order == true) {
          ...
          tep_session_register('cart_interkassa_id');
        }
      }
    ...
    function process_button() {
      global $customer_id, $order, $sendto, $currency, $currencies, $cart_interkassa_id, $shipping;
    ...
    function before_process() {
      global $customer_id, $order, $order_totals, $sendto, $billto, $languages_id, $payment, $currencies, $cart, $cart_interkassa_id;
      global $$payment;
