...
//Site thema configuration
  ...
  $cptemplate = tep_db_fetch_array($customer_pref_template_query);
	...
	define(TEMPLATE_NAME, $cptemplate['template_selected']);
  	...
  	define(TEMPLATE_STYLE_ORIGINAL, DIR_WS_TEMPLATES . DEFAULT_TEMPLATE . "/stylesheet.css");
	...
	define(TEMPLATE_NAME, DEFAULT_TEMPLATE);
  	...
  	define(TEMPLATE_STYLE_ORIGINAL, DIR_WS_TEMPLATES . DEFAULT_TEMPLATE . "/stylesheet.css");
        ...
        tep_db_query('UPDATE configuration SET configuration_value = "Helius" WHERE configuration_title="default theme"');
define(TEMPLATE_NAME, 'Helius');
  	define(TEMPLATE_STYLE, DIR_WS_TEMPLATES . TEMPLATE_NAME . "/stylesheet.css");
        require(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/boxes.tpl.php');
}
//:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
if ($_GET['action']) {
    switch ($_GET['action']) {
      ...
      if ($template >= '1'){
         $thema_template = tep_db_prepare_input($_POST['template']);
