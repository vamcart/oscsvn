<?php
/*
  $Id: redirect.php,v 1.2 2003/09/24 14:33:16 wilt Exp $
...
// VJ Links Manager v1.00 begin
    case 'links':
      ...
      $links_query = tep_db_query("select links_url from " . TABLE_LINKS . " where links_id = '" . (int)$_GET['goto'] . "'");
      if (tep_db_num_rows($links_query)) {
        $link = tep_db_fetch_array($links_query);
        tep_update_links_click_count($_GET['goto']);
