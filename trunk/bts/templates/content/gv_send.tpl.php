...
?>
      <tr>
        <td class="main"><?php echo tep_image(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/content/man_on_board.gif', HEADING_TITLE, '0', '0', 'align="left"') . TEXT_SUCCESS; ?><br><br><?php echo 'gv '.$id1; ?></td>
      </tr>
      <tr>
