<?php echo tep_draw_form('newsdesk_reviews_write', tep_href_link(FILENAME_NEWSDESK_REVIEWS_WRITE, 'action=process&newsdesk_id=' . $_GET['newsdesk_id'], 'NONSSL'), 'post', 'onSubmit="return checkForm();"'); ?>
...
<?php echo tep_image(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/content/reviews.gif', HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?>		</td>
	</tr>
</table></td>
      </tr>
