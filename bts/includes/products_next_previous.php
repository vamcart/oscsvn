...
?>
    <table border="0" align="center" width="100%">
      <tr>
        <td align="left" class="main"><a href="<?php echo tep_href_link(FILENAME_PRODUCT_INFO, "products_id=".$previous.$manufacturer); ?>"><?php echo tep_template_image_button('button_prev.gif', IMAGE_BUTTON_PREVIOUS); ?></a></td>
        ...
        <td align="right" class="main">&nbsp;<a href="<?php echo tep_href_link(FILENAME_PRODUCT_INFO, "products_id=".$next_item.$manufacturer); ?>"><?php echo tep_template_image_button('button_next.gif', IMAGE_BUTTON_NEXT); ?></a></td>
      </tr>
    </table>
