...
if ($_POST[xsell_id])
 ...
 ?>
                ...
                <tr>
                  <td class="main"><?php echo sprintf(TEXT_LINK_SORT_PRODUCTS, tep_href_link(FILENAME_ARTICLES_XSELL, '&sort=1&add_related_article_ID=' . $_GET['add_related_article_ID'], 'NONSSL')); ?></td>
                </tr>
                <tr>
                  <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                </tr>
...
//	  if ($_POST[xsell_id])
	...
	?>
	<form method="post" action="<?php tep_href_link(FILENAME_ARTICLES_XSELL, 'sort=1&add_related_article_ID=' . $_GET['add_related_article_ID'], 'NONSSL'); ?>">
