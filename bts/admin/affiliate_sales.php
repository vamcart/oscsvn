<?php
/*
  $Id: affiliate_sales.php,v 1.2 2003/09/24 13:57:05 wilt Exp $
...
*/
  ...
  if ($_GET['acID'] > 0) {
    ...
    $affiliate_sales_raw = "
      ...
      ";
    $affiliate_sales_split = new splitPageResults($_GET['page'], MAX_PROD_ADMIN_SIDE, $affiliate_sales_raw, $affiliate_sales_numrows);
...
?>
          <tr>
            <td colspan="7"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="smallText" valign="top"><?php echo $affiliate_sales_split->display_count($affiliate_sales_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_SALES); ?></td>
                <td class="smallText" align="right"><?php echo $affiliate_sales_split->display_links($affiliate_sales_numrows, MAX_PROD_ADMIN_SIDE, MAX_DISPLAY_PAGE_LINKS, $_GET['page'], tep_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></td>
              </tr>
            </table></td>
          </tr>
<?php
