<?php
/*
  $Id: stats_customers.php,v 1.2 2003/09/24 15:18:15 wilt Exp $
          ...
          <tr>
            <td colspan="3"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td class="smallText" align="right"><?php echo $customers_split->display_links($customers_query_numrows, MAX_PROD_ADMIN_SIDE, MAX_DISPLAY_PAGE_LINKS, $_GET['page']); ?>&nbsp;</td>
              </tr>
            </table></td>
          </tr>
        </table></td>
