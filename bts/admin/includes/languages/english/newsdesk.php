...
define('TEXT_INFO_HEADING_MOVE_PRODUCT', 'Move:');

define('TEXT_PRODUCTS_IMAGE_REMOVE_SHORT', 'Remove');
define('TEXT_PRODUCTS_IMAGE_DELETE_SHORT', 'Delete');

define('TEXT_NEWSDESK_ENABLE', '1 = Enabled.');
define('TEXT_NEWSDESK_DISABLE', '0 = Disabled.');

define('TEXT_NEWSDESK_DATA', 'Data');
define('TEXT_NEWSDESK_IMAGES', 'Images');
