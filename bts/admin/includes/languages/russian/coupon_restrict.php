...
define('TEXT_NEWSLETTER_CUSTOMERS', 'Всем подписчикам рассылки интернет-магазина');
...
define('COUPON_PRODUCTS_HELP', 'Вы можете ограничить действие купона только лишь на конкретные товары в Вашем интернет-магазине. Пропустите данное поле, если Вы не хотите устанавливать ограничений.');
define('COUPON_CATEGORIES_HELP', 'Вы можете ограничить действие купона только лишь на конкретные категории в Вашем интернет-магазине. Пропустите данное поле, если Вы не хотите устанавливать ограничений.');
?>