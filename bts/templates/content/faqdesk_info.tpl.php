...
<?php echo tep_image(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/content/reviews.gif', TEXT_FAQDESK_HEADING, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?>
</td>
          </tr>
	          </table></td>
      </tr>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="main">
<?php echo sprintf(TEXT_FAQDESK_LINK, tep_href_link(FILENAME_REDIRECT, 'action=faqurl&goto=' . urlencode($product_info_values['faqdesk_extra_url']), 'NONSSL', true, false)); ?>
		</td>
	</tr>
</table>
<?php } ?>
