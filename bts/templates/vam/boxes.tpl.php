...
// class constructor
  ...
  class infoBoxHeading extends tableBox {
    function infoBoxHeading($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents = array();
      $info_box_contents[] = array(array('params' => 'height="14" class="pageHeading"',
                                         'text' => $left_corner),
                                   array('params' => 'width="100%" height="14" class="pageHeading"',
                                         'text' => $contents[0]['text']),
                                   array('params' => 'height="14" class="pageHeading" nowrap',
                                         'text' => $right_corner));
  ...
  class contentBoxHeading extends tableBox {
    function contentBoxHeading($contents) {
      ...
      $info_box_contents[] = array(array('params' => 'height="14" class="pageHeading"',
                                   ...
                                   array('params' => 'height="14" class="pageHeading" width="100%"',
                                         'text' => $contents[0]['text']),
                                   array('params' => 'height="14" class="pageHeading"',
